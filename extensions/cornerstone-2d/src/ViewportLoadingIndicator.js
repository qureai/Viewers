  ...
  if (error) {
    return (
      <>
        ...
        <div className="text-red-500 text-base font-light w-full h-full flex flex-col items-center justify-center">
  ...
  return (
    <>
      ...
      <div className="absolute transparent w-full h-full flex items-center justify-center">
        <p className="text-teal-600 text-base font-light">Loading...</p>
      </div>
    </>
  );
};
